...
function [Wv,Wn] = nmf_supervised_disc(S1,S2,Wv,Wn,options)
...
weight = 1;
beta2 = 2;
lossFun    = @(Vv,Vn,Wv,Hv,Wn,Hn) betadiv(Vv,Wv*Hv,beta2) + weight*betadiv(Vn,Wn*Hn,beta2)-betadiv(Wv*Hv,Wn*Hn,2);
gradFun_hv    = @(Vv,Vn,Wv,Hv,Wn,Hn) betadiv_grad(Vv,Wv,Hv,beta2,'dH') - betadiv_grad(Wn*Hn,Wv,Hv,2,'dH');
gradFun_hn    = @(Vv,Vn,Wv,Hv,Wn,Hn) weight*betadiv_grad(Vn,Wn,Hn,beta2,'dH') - betadiv_grad(Wv*Hv,Wn,Hn,2,'dH');
gradFun_wv    = @(Vv,Vn,Wv,Hv,Wn,Hn) betadiv_grad(Vv,Wv,Hv,beta2,'dW') - betadiv_grad(Wn*Hn,Wv,Hv,2,'dW'); 
gradFun_wn    = @(Vv,Vn,Wv,Hv,Wn,Hn)weight*betadiv_grad(Vn,Wn,Hn,beta2,'dW')- betadiv_grad(Wv*Hv,Wn,Hn,2,'dW'); 
