...
for i=1:numel(net.layers)
    if ~strcmp(net.layers{i}.type,'conv') && ~strcmp(net.layers{i}.type,'sc'), continue; end
  ...
  if strcmp(net.layers{i}.type,'sc') ,
  net.layers{i}.filtersMomentum = zeros('like',net.layers{i}.dict) ;
  end
...
for epoch=1:opts.numEpochs
  ...
  for t=1:opts.batchSize:numel(train)
    ...
    % gradient step
    for l=1:numel(net.layers)
        if strcmp(net.layers{l}.type, 'sc'),
            net.layers{l}.filtersMomentum = ...
                opts.momentum * net.layers{l}.filtersMomentum ...
                - (lr * net.layers{l}.filtersLearningRate) * ...
                (opts.weightDecay * net.layers{l}.filtersWeightDecay) * net.layers{l}.dict ...
                - (lr * net.layers{l}.filtersLearningRate) / numel(batch) * res(l).dzdw{1} ;
            

            net.layers{l}.dict = mexNormalize( net.layers{l}.dict + net.layers{l}.filtersMomentum );
