...
Also, there is again in including a deeper representation \emph{scatt-NMF\textsubscript{2}} performs always better than \emph{scatt-NMF\textsubscript{1}} 

In all the experiments, we solved (\ref) using a greedy approximation. We expect that solving it explicitly would bring some additional improvement.

\begin{table}[tb]
\caption{Separation with speakers-specific models. Average SDR, SIR, SAR and SNR (in $dB$) for NMF and proposed  and \emph{scatt-NMF\textsubscript{2}}. Standard deviation of each result shown between brackets. \label{ta:eval}}
\vspace{-1.5ex}
\begin{center}
\small{
...
\hline
\emph{scatt-NMF\textsubscript{1}} & 10.2 [1.4] &   15.2 [0.7] & 11.0 [1.7] &    10.0 [1.2]\\
\emph{scatt-NMF\textsubscript{2}} &  10.7 [1.3] & 14.1 [1.2]  & 10.3 [1.5] &  9.1 [1.1]\\
  \hline\hline
\end{tabular}
}
\end{center}
...
& SDR & SIR & SAR & SNR\\
\hline
NMF    & 6.1 [2.9] &   14.1 [3.8] & 7.4 [2.1] &   6.4 [2.7]\\
\hline
\emph{scatt-NMF\textsubscript{1}} &  6.1 [2.9] &   14.1 [3.8] & 7.4 [2.1] &   6.4 [2.7]\\
\emph{scatt-NMF\textsubscript{2}} &  6.9 [2.7] & 16.0 [3.5]  & 7.9 [2.2] &  9.1 [1.1]\\
  \hline\hline
\end{tabular}
}
\end{center}
