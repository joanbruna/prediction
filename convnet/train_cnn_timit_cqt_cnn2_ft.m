...
load /misc/vlgscratch3/LecunGroup/pablo/models/cnn/timit-cnn-cqt-cnn2/net-epoch-150.mat


opts.expDir = '/misc/vlgscratch3/LecunGroup/pablo/models/cnn/timit-cnn-cqt-cnn2-fine-tunned/';
...
opts.train.learningRate = C*[0.001*ones(1,20) 0.0001];
